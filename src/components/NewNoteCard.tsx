...
export function NewNoteCard({ onNoteCreate }: NewNoteCard) {
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger className="flex flex-col items-start gap-3 rounded-md bg-slate-700 p-5 text-left outline-none hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
          ...
          <form className="flex flex-1 flex-col">
            ...
            {isRecording ? (
              <button
                ...
                className="text-salte-300 flex w-full items-center justify-center gap-2 bg-slate-900 py-4 text-center text-sm font-medium outline-none transition-colors hover:text-slate-100"
              >
